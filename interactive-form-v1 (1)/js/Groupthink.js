...
//hide "select Theme" from t-shirt menu-not working--should hide everything that's not//
...
$('.activities').change(function(event) {
   ...
   /***Not working at all--I want the code to go through each and compare the date time,
    *  names and deselect based on attributes--
    */  
   
   const $activityCheckBox = $('.activities input');
   const $currentDateTime = $activityCheckBox;
   ...
   $activityCheckBox.each(function(i){
    ...
    // variable checkboxInputName &  $checkedBox.attr('name') are the same
